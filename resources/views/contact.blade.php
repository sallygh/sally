    ...
    <div class="container py-4">
      ...
      @csrf
          ...
          <div class="mb-3">
            ...
            <input class="form-control" id="name" name="name" type="string" placeholder="Name" />
          </div>
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="message" type="text" placeholder="Message"  name="contact" style="height: 10rem;" ></textarea>
          </div>
